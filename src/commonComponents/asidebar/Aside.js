            ...
            <div className="deznav-scroll " >
                <ul className="metismenu" id="menu">
                    ...
                    <li><a href="core-hr.html" className aria-expanded="false">
                        ...
                        <span className="nav-text">Direct Child List</span>
                    </a>
                    </li>
                    ...
                    <li><a className="d-flex" href=";" aria-expanded="false" >
                        ...
                        <div> <span className="nav-text">Manage Operators  <br />+ BackUP API</span></div>
                    </a>

                    </li>
                    <li><a href="performance.html" className='d-flex' aria-expanded="false">
                        <div className="menu-icon">
                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><a className="has-arrow " href=";" aria-expanded="false">
                        ...
                        <span className="nav-text">Denomination</span>
                    </a>
                        <ul aria-expanded="false" className='listStyle'>
                            <li><a href="">Denomination Wise API Switch	</a></li>
                            <li><a href="">
                                Denomination Range Wise API Switch</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a className="has-arrow " href=";" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" className='listStyle'>
                            <li><a href="">Create Commission Scheme	</a></li>
                            <li><a href=""> Manage Commission Scheme</a></li>
                            <li><a href=""> DMT Commission Scheme</a></li>
                            <li><a href=""> AEPS Commission Scheme	</a></li>
                            <li><a href=""> Payout Commission Scheme</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a className="has-arrow " href=";" aria-expanded="false">
                        ...
                        <span className="nav-text">Amounts</span>
                    </a>
                        <ul aria-expanded="false" className='listStyle'>
                            <li><a href="">Amount Master</a></li>
                            <li><a href=""> Amount Range Master</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a className="has-arrow " href=";" aria-expanded="false">
                        ...
                        <span className="nav-text">Send Master</span>
                    </a>
                        <ul aria-expanded="false" className='listStyle'>
                            <li><a href="">Send Message
                            </a></li>
                    ...
                    <li><a className="has-arrow " href=";" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" className='listStyle'>
                            <li><a href="">Recharge Reports
                            </a></li>
                            <li><a href="">Payout Report
                            </a></li>
                            <li><a href=""> AEPS Report</a></li>
                    ...
                    <li><a className="has-arrow " href=";" aria-expanded="false">
                        ...
                        <span className="nav-text">Pendings</span>
                    </a>
                        <ul aria-expanded="false" className='listStyle'>
                            <li><a href="">Pending Transactions
                            </a></li>
                            <li><a href="">Pending Bank Transfers
                            </a></li>
                        </ul>
                    </li>
                    <li><a href="manage-client.html" className aria-expanded="false">
                        ...
                        <span className="nav-text">Recharge Report</span>
                    </a>
                    </li>
                    <li><a href="manage-client.html" className aria-expanded="false">
                        <div className="menu-icon">
